sap.ui.define([
    ...
    return BaseController.extend("com.ecui.payment_applications.PaymentApplications", {
        ...
        onInit() {
            ...
            this.oRouter.getRoute("payment-applications").attachPatternMatched(this._onRouteMatched, this);
            this._tableId = this.byId("table_PaymentApplications");
                ...
                [
                    {
                        "applicationNo": "1",
                        "status": 1,
                        "orginal_PA_Value": "80000.00AED",
                        "updated_PA_Value": "75000.00AED",
                        "invoice": "1000067",
                        "invoice_Value": "75000067.00AED",
                        "due_Date": "10-02-2025",
                    ...
                    },
                    {
                        "applicationNo": "2",
                        "status": 2,
                        "orginal_PA_Value": "40000.00AED",
                        "updated_PA_Value": "65000.00AED",
                        "invoice": "1000088",
                        "invoice_Value": "1000067.00AED",
                        "due_Date": "11-02-2025",
                        "submitted_Date": "14-02-2025",
                        "projects": "Tower AC  C.00.001",
                        "customer": "Project With Revenue",
                        "company": "ABC Company",
                        "manage": "",
                    ...
                    },
                    {
                        ...
                        "status": 4,
                        "orginal_PA_Value": "80000.00AED",
                        "updated_PA_Value": "64000.00AED",
                        "invoice": "9000088",
                        "invoice_Value": "5500067.00AED",
                        "due_Date": "16-02-2025",
                        "submitted_Date": "19-02-2025",
                        "projects": "Tower  EC.00.001",
                        "customer": "Project With Revenue",
                        "company": "Inflexion-oman",
                        "manage": "",
                    ...
                    },
                    {
                        "applicationNo": "4",
                        "status": 3,
                        "orginal_PA_Value": "44000.00AED",
                        "updated_PA_Value": "94000.00AED",
                        "invoice": "2000088",
                        "invoice_Value": "900067.00AED",
                        "due_Date": "14-02-2025",
                        "submitted_Date": "19-02-2025",
                        "projects": "Construction  Plan B.00.001",
                        "customer": "Project With Revenue",
                        "company": "Inflexion-Dubai",
                        "manage": "",
            ...
            this.getView().setModel(oModel, "paymentApplicationsMdl");
            this.LocalDataFetch();
        ...
        async onValueHelpRequestCustomer(oEvent) {
            ...
            this.oCustomerDialog ??= await this.loadFragment({
                name: "com.ecui.payment_applications.fragments.SupplierDialogPayment",
            });
        ...
        onListItemPress(oEvent) {
            let systemCtxt = oEvent.getSource().getSelectedItem().getBindingContext('paymentApplicationsMdl');
            let payment = systemCtxt.getObject();
            let oSettingsModel = this.oOwnerComponent.getModel('settings');
            let oNextUIState;
            oSettingsModel.setProperty("/navigatedItem", payment.applicationNo);
            //this.oRouter.navTo("payment-applications-detail", { layout: "OneColumn", id: payment.applicationNo });

            this.getOwnerComponent().getHelper().then(function (oHelper) {
                oNextUIState = oHelper.getNextUIState(0);
                this.oRouter.navTo("payment-applications-detail", { layout: "MidColumnFullScreen", id: payment.applicationNo });
            }.bind(this));
        },

        // onPressMessage: function (oEvent) {
        //     let rowObj = oEvent?.oSource?.oPropagatedProperties?.oBindingContexts?.paymentApplicationsMdl?.getObject()|| '';
...
<table style="width: 100%; margin-top: 20px; text-align: center;">
    <tr>
        ...
        onCreateApplication: function () {
            ...
            this.getOwnerComponent().getRouter().navTo("create-payment-application", { layout: "OneColumn" });
        ...
        onSearch: function (oEvent) {
            ...
            this.byId("table_PaymentApplications").getBinding("items").filter(aFilter, "Application");
        },
        ...
        _openPersoDialog: function (aPanels, oSource) {
            let _tableId = this.byId("table_PaymentApplications");
        ...
        handleStateChange: function (oEvt) {
            const _tableId = this.byId("table_PaymentApplications");
            ...
            const aCells = oState.Columns.map(function (oColumnState) {
                ...
                const colPath = 'paymentApplicationsMdl>' + oProperty.path;
