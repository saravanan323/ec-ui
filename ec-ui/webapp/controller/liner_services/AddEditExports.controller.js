sap.ui.define([
    ...
    "use strict";
    var that = this;
    return BaseController.extend("com.ecui.controller.liner_services.AddEditExports", {
        ...
        _onRouteMatched: function (oEvent) {
            ...
            this.getView().setModel(new JSONModel({ route: this._route, item: this._item, consignee: [], containerDetails: [], cargoDetails: [], freightDetails: [], consigneeCount: 0, cargoCount: 0, containerCount: 0, freightCount: 0 }), "ExportsMdl");
            this._mockData();
        },
        ...
        handleClose: function () {
            ...
            this.oRouter.navTo("manageExports", { layout: sNextLayout });
        },

        onExit: function () {
            this.oRouter.getRoute("manageExports").detachPatternMatched(this._onRouteMatched, this);
